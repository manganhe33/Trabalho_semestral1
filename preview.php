...
<head>
	...
	<title>Campo de registro 2023</title>
...
<div class="container-fluid">
	<?php $sql="SELECT count(*) from cadastro WHERE reg_no=:reg_no"; 
    	 $stmt = $db->prepare($sql);
  ...
  <div class="col-sm-1">
    ...
    <div class="col-sm-10" style="border: 2px solid black; padding:10px;">
    	<?php 
         ...
         $sql="SELECT * from cadastro WHERE reg_no=:reg_no"; 
         $stmt = $db->prepare($sql);
           $stmt->bindParam(':reg_no', $reg_no, PDO::PARAM_STR);
           $stmt->execute();
           $rows=$stmt->fetchall();
...
<div class="row">
   ...
   <div class="col-4">
      ...
      <label class="lable">Numero de Registro</label>
    </div>
     <div class="col-8">
   ...
   <div class="col-4">
    ...
    <div class="form-group row">
   <div class="col-4">
      <label class="lable">Nome da Mãe</label>
    </div>
     <div class="col-8">
       <?php echo $row['mname']; ?> 
    </div>
...
<div class="form-group row">
  ...
  <div class="row">
    <div class="col-6">
     <div class="form-group row">
   <div class="col-4">
      <label class="lable">Valor de inscricão</label>
    </div>
     <div class="col-8">
    <?php echo $row['course_fees']; ?> MT  
    </div>
    </div>
    </div>
    <div class="col-6">
     <div class="form-group row">
   <div class="col-4">
      <label class="lable">Estado de pagamento</label>
    </div>
     <div class="col-8">
...
<br>
<center><button type="button" class="btn btn-warning" id="printbtn" onclick="window.print()">Imprimir</button></center>
<br>
<?php } ?> 
